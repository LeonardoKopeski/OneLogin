...
class App extends React.Component{
    ...
    componentDidMount(){
        if(this.state.infoRequested == false){
            ...
            socket.emit("getBasicInfo", {username, requester: getCookie("token")})
